...
abstract class MovieRemoteDataSource {
  ...
  Future<MovieDetailResponse> getMoviesDetails(int id);
  Future<List<MovieModel>> getMoviesRecomendations(int id);
...
class MovieRemoteDataSourceImpl implements MovieRemoteDataSource {
  ...
  @override
  Future<MovieDetailResponse> getMoviesDetails(int id) async {
    final response =
  ...
  @override
  Future<List<MovieModel>> getMoviesRecomendations(int id) async {
