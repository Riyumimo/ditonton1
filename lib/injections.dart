...
void init() {
  ...
  //repository
  locator.registerLazySingleton<MovieRepository>(() => MovieRepositoryImpl(locator(), locator()));

  //data source 
  locator.registerLazySingleton<MovieLocalDataSource>(() => MovieLoacalDataSourceImpl(databaseHelper: locator()));
